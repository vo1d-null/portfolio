...
const info = [
  {
    icon : <FaPhoneAlt />,
    title : 'Phone',
    description : '(+359) 098 830 1845'
  },
  {
    icon : <FaEnvelope />,
    title : 'Email',
    description : 'vo1d.null299@gmail.com'
  },
  {
    icon : <FaMapMarkerAlt />,
    title : 'Address',
    description : 'Sofia, Bulgaria , str. Boycho Ognyanov, 15A, 1618'
  },
]
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="nst"> SEO Optimization</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              {/* textarea */}
